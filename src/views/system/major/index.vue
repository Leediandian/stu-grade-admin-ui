  ...
  <div class="app-container">
      ...
      <el-table-column label="所属院系" align="center" prop="departmentId" >
        <template #default="scope">
          <div style="display: flex; align-items: center">
            <span  v-if="scope.row.stuDepartment && !!scope.row.stuDepartment.departmentName" v-text="scope.row.stuDepartment.departmentName"></span>
          </div>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="所属院系编号" prop="departmentId">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        departmentId: [
          { required: true, message: "所属院系编号不能为空", trigger: "blur" }
        ],
        delFlag: [
